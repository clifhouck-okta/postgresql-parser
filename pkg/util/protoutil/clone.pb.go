...
import github_com_cockroachdb_cockroach_pkg_util_uuid "github.com/clifhouck-okta/postgresql-parser/pkg/util/uuid"
...
type RecursiveAndUncloneable struct {
	...
	Uuid github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,2,opt,name=uuid,proto3,customtype=github.com/clifhouck-okta/postgresql-parser/pkg/util/uuid.UUID" json:"uuid"`
}

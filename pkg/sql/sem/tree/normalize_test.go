...
import (
	...
	//_ "github.com/clifhouck-okta/postgresql-parser/pkg/sql/sem/builtins"
	...
	"github.com/clifhouck-okta/postgresql-parser/pkg/util/leaktest"
)
...
func TestNormalizeExpr(t *testing.T) {
	...
	testData := []struct {
		...
		// https://github.com/clifhouck-okta/postgresql-parser/issues/32639
